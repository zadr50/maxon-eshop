...
<script>
  ...
  import { mapStateMutations,mapState } from 'vuex'
  ...
  export default {
    ...
    components:{
      ...
      'layout-tablet':LayoutTablet
    },
    methods: {
      onCollapse() {
        this.$refs.appSidebar.onCollapse()      
      }
    }
  };
</script>
...
<style>
html {
  font-family: 'Segoe UI','Source Sans Pro', -apple-system, BlinkMacSystemFont, 
